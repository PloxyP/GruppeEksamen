...
def welcome_message(eyes_detected):
    ...
    while True:
        ...
        if eyes_detected and eyes_detected[0]:  # Check if the list is not empty and its first element is True
            ...
            eyes_detected[0] = False  # Reset the variable after displaying the message
        else:
...
if __name__ == "__main__":
    eyes_detected = [False]  # Initial value as a list

    pygame.init()  # Initialize Pygame before creating the thread
